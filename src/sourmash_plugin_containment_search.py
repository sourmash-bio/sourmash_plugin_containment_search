...
def mgsearch(query_filename, against_list, *,
    ...
    for metag_filename in against_list:
        ...
        results_d = dict(intersect_bp=result.intersect_bp,
                         ...
                         f_query=result.f_query_match,
                         f_match=result.f_match_query,
                         ...
                         genome_containment_ani=result.match_containment_ani,
                         match_containment_ani=result.query_containment_ani,
